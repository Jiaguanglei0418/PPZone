...
#import "PPAuthorHttpUtils.h" // author 认证工具类
...
- (void)accessTokenWithCode:(NSString *)code
{
     ...
     */
    PPAuthorHttpParams *param = [PPAuthorHttpParams param];
    param.code = code;
    param.client_id = APPKEY_Sina;
    param.client_secret = APPSECRET_Sina;
    param.redirect_uri = APPREDIRECT_Sina;
    param.grant_type = @"authorization_code";

    [PPAuthorHttpUtils authorParams:param success:^(PPAccount *account) {
